*** Settings ***
Documentation     Downloads the Order file (.csv).
...               Saves each order HTML receipt as a PDF file.
...               Saves a screenshot of each of the ordered robots.
...               Embeds the screenshot of the robot to the PDF receipt.
...               Creates a ZIP archive of the PDF receipts. Store the archive in the output directory.
